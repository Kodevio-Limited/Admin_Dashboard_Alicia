...
function Avatar({
    ...
    return (
        <AvatarPrimitive.Root
            ...
            data-size={size}
            className={cn(
                'group/avatar relative flex size-10 shrink-0 rounded-full select-none after:absolute after:inset-0 after:rounded-full after:border after:border-border after:mix-blend-darken data-[size=lg]:size-11 data-[size=sm]:size-9 dark:after:mix-blend-lighten',
                className,
            )}
            {...props}
        />
...
function AvatarGroup({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'group/avatar-group flex [&>*:not(:first-child)]:-ml-2 *:data-[slot=avatar]:ring-2 *:data-[slot=avatar]:ring-background',
                className,
            )}
            {...props}
        />
    ...
    return (
        <div
            ...
            className={cn(
                ...
                'group-has-data-[size=sm]/avatar-group:size-9',
                '[&>svg]:size-4',

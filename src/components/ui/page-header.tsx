    ...
    return (
        <div className={cn('flex flex-col md:flex-row md:items-start justify-between w-full gap-4 shrink-0', className)}>
            ...
            <div className="flex flex-col items-end gap-1.5 justify-start">
                {lastUpdated && (
                    <div className="flex items-center gap-1.5 text-[#989898]">
                ...
                <div className="flex items-center gap-3">
                    {children}
                    <div className="bg-white shadow-sm h-9 items-center gap-2 rounded-full w-[260px] lg:w-[320px] px-3 cursor-text transition-colors hover:bg-white/90 hidden md:flex border border-black/5 focus-within:border-[#03045e]/20 focus-within:bg-white focus-within:ring-2 focus-within:ring-[#03045e]/10">

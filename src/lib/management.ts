...
export let RESIDENTS: ResidentRow[] = [
    { id: 1, name: 'Grace Reid', email: 'grace@example.com', community: 'Savanna-la-Mar', lastCheckIn: '14 min ago', status: 'ACTIVE', avatar: '/avatars/shadcn.jpg', },
    { id: 2, name: 'Omar Symister', email: 'omar@example.com', community: 'Frome', lastCheckIn: '2 hr ago', status: 'DELAYED', avatar: '/avatars/shadcn.jpg', },
    { id: 3, name: 'Amber Mitchell', email: 'amber@example.com', community: 'Petersfield', lastCheckIn: '6 hr ago', status: 'SILENT', avatar: '/avatars/shadcn.jpg', },
    { id: 4, name: 'Juline Asquith', email: 'juline@example.com', community: 'Little London', lastCheckIn: '6 min ago', status: 'ACTIVE', avatar: '/avatars/shadcn.jpg', },
    { id: 5, name: 'Racquel Brown', email: 'racquel@example.com', community: 'Darliston', lastCheckIn: '10 min ago', status: 'ACTIVE', avatar: '/avatars/shadcn.jpg', },
    { id: 6, name: 'Diana Spencer', email: 'diana@example.com', community: 'Whithorn', lastCheckIn: '25 min ago', status: 'ACTIVE', avatar: '/avatars/shadcn.jpg', },
    { id: 7, name: 'James Anderson', email: 'james.a@example.com', community: 'Negril', lastCheckIn: '1 min ago', status: 'ACTIVE', avatar: '/avatars/shadcn.jpg', },
    { id: 8, name: 'Lisa Wong', email: 'lisa.w@example.com', community: 'Lucea', lastCheckIn: '12 hr ago', status: 'SILENT', avatar: '/avatars/shadcn.jpg', },
    { id: 9, name: 'Marcus Garvey', email: 'marcus.g@example.com', community: 'Green Island', lastCheckIn: '4 hr ago', status: 'DELAYED', avatar: '/avatars/shadcn.jpg', },

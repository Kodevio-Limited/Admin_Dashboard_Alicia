import { MapPin, BatteryWarning, BriefcaseMedical, Waves, TrafficCone, TreePine } from 'lucide-react'
...
export let HAZARDS: HazardItem[] = [
    ...
    { id: 2, lng: -76.805, lat: 18.005, type: 'Blocked Road', icon: TrafficCone, color: '#FEBD09', pulse: true, size: 'lg' },
    ...
    { id: 7, lng: -76.775, lat: 18.005, type: 'Fallen Tree', icon: TreePine, color: '#FEBD09', pulse: false, size: 'md' },
    ...
    { id: 11, lng: -76.802, lat: 18.008, type: 'Blocked Road', icon: TrafficCone, color: '#FEBD09', pulse: true, size: 'lg' },
